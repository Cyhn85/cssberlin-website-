                    ...
                    <div class="auth-modal-v3-form">
                        ...
                        <div id="loginView" class="auth-view">
                            ...
                            <div class="auth-modal-v3-socials">
                                <!-- Google Button (Standard: White with Color Icon) -->
                                <button class="auth-modal-v3-social-btn google" onclick="window.authModalV3.loginWithGoogle()" title="Mit Google anmelden">
                                    <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M9 3.58c1.321 0 2.508.455 3.44 1.346l2.581-2.58C13.463.891 11.426 0 9 0A8.997 8.997 0 0 0 .957 4.958L3.964 7.29C4.672 5.159 6.656 3.58 9 3.58z" fill="#EA4335"/>
                                    </svg>
                                    <span style="color: #1f1f1f; font-weight: 500;">Google</span>
                                </button>
                                
                                <!-- Apple Button (Standard: Black with White Icon) -->
                                <button class="auth-modal-v3-social-btn apple" onclick="window.authModalV3.loginWithApple()" title="Mit Apple anmelden">
                                    <svg width="19" height="19" viewBox="0 0 24 24" fill="white">
                                        <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                                    </svg>
                                    <span style="color: white; font-weight: 500;">Apple</span>
                                </button>
                            </div>
                        </div>
