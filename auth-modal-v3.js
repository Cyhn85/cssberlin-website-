...
(function () {
        ...
        const html = `
            <div class="auth-modal-v3-overlay" id="authModalV3Overlay">
                <div class="auth-modal-v3">
                    <button class="auth-modal-v3-close" id="authModalV3Close" title="Schließen">×</button>
                    ...
                    <div class="auth-modal-v3-form">
                        ...
                        <div id="loginView" class="auth-view">
                            ...
                            <div class="auth-modal-v3-socials">
                                ...
                                <button class="auth-modal-v3-social-btn" onclick="window.authModalV3.loginWithTwitter()" title="Mit Twitter">
    ...
    function loginWithTwitter() {
        showMessage('Twitter Login kommt bald', 'error');
    }

    // ─── Event Listeners ────────────────────────────────────────
    function attachEvents() {
        document.getElementById('authModalV3Close').addEventListener('click', close);
