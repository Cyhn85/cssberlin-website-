...
function createProductCard(product) {
    ...
    return `
        <div class="product-card-v3 ${isSold ? 'product-card-sold' : ''}" data-product-id="${product.id}">
            <div class="product-card-v3-inner">
                <div class="product-card-v3-img-wrap">
                    ...
                    ${isSold ? '<div class="product-card-v3-badge" style="background:rgba(180,30,30,0.88);">VERKAUFT</div>' : `<div class="product-card-v3-badge">${product.condition}</div>`}
                    ...
                    <!-- Hover overlay: wishlist + cart + quick-view -->
                ...
                <div class="product-card-v3-body">
                    ...
                    <div class="product-card-v3-seller">
                        ...
                        <div class="product-card-v3-seller-info">
                            ...
                            <br>${ratingLabel} · 📍 ${location} · 🕐 ${uploadedAgo}
                        </div>
                    </div>

                    <!-- 2-Button layout: Chat (brand outline) + Kaufen (rainbow animated) -->
