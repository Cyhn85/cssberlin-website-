    ...
    <nav class="nav-bar-v2" data-global-shell="1">
        <div class="nav-bar-v2-inner">
            ...
            <div class="nav-bar-v2-item">
                ...
                <div class="nav-bar-v2-dropdown"><div class="nav-bar-v2-dropdown-inner">
                    <a href="damen.html">Damen Sale</a>
                    <a href="herren.html">Herren Sale</a>
                    <a href="index.html">Tech Deals</a>
                    <a href="index.html">Last Chance</a>
                    <a href="index.html">Unter 20€</a>
                    <a href="index.html">Unter 50€</a>
                </div></div>
            </div>
            <div class="nav-bar-v2-item">
                ...
                <div class="nav-bar-v2-dropdown"><div class="nav-bar-v2-dropdown-inner">
                    ...
                    <a href="inserieren.html">Verkaufen</a>
                    <a href="wie-funktioniert-es.html">Versand</a>
                    <a href="wie-funktioniert-es.html">Echtheitsprüfung</a>
                    <a href="wie-funktioniert-es.html">Rückgabe</a>
                </div></div>
            </div>
        </div>
    </nav>
