...
// ============================================
// REAL PRODUCTS DATA FROM API
// ============================================

// Global products array
let allProducts = [];

// Fetch products from API or products.json
async function loadProducts() {
    try {
        // Try loading from products.json (for static site)
        const response = await fetch('/products.json');

        if (!response.ok) {
            console.warn('products.json not found, using empty array');
            return [];
        }
...
// ============================================
// FALLBACK SAMPLE PRODUCTS (if no products.json)
// ============================================
...
async function initProducts() {
    ...
    // Use sample products if none loaded
    if (allProducts.length === 0) {
        console.warn('No products loaded, using sample data');
    ...
    // Load first products
    const productsToShow = allProducts.slice(0, productsPerPage);
